...
public class ClassWithAdapterDiffblueTest {
   ...
   *
   * <ul>
   *   <li>Given {@link IOException#IOException(String)} with {@code custom}.
  ...
  public void testAdapterRead_givenIOExceptionWithCustom_thenThrowIOException() throws IOException {
    // Arrange
