...
public class UtcDateTypeAdapterDiffblueTest {
  ...
  public void testRead_whenCharArrayReaderWith1ToCharArray_thenThrowJsonParseException()
    ...
    // Arrange
    UtcDateTypeAdapter utcDateTypeAdapter = new UtcDateTypeAdapter();
    CharArrayReader in = new CharArrayReader("1\u0006\u0001\u0006".toCharArray());
   ...
   *
   * <ul>
   *   <li>When {@link CharArrayReader#CharArrayReader(char[])} with {@code 11} toCharArray.
   *   <li>Then throw {@link JsonParseException}.
   * </ul>
   *
   * <p>Method under test: {@link UtcDateTypeAdapter#read(JsonReader)}
  ...
  @ManagedByDiffblue
  @MethodsUnderTest({"Date UtcDateTypeAdapter.read(JsonReader)"})
  public void testRead_whenCharArrayReaderWith11ToCharArray_thenThrowJsonParseException()
      throws IOException {
    // Arrange
    UtcDateTypeAdapter utcDateTypeAdapter = new UtcDateTypeAdapter();
    CharArrayReader in = new CharArrayReader("11\u0001\u0006".toCharArray());
  ...
  @ManagedByDiffblue
  @MethodsUnderTest({"Date UtcDateTypeAdapter.read(JsonReader)"})
  public void testRead_whenStringReaderWithHttpsGithubComGoogleGsonBlobMainTroubleshootingMd()
      throws IOException {
    // Arrange
    UtcDateTypeAdapter utcDateTypeAdapter = new UtcDateTypeAdapter();
