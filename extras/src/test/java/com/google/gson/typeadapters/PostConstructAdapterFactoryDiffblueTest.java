...
public class PostConstructAdapterFactoryDiffblueTest {
   ...
   *       JsonNull} (default constructor) hasNext.
   * </ul>
   *
  ...
  public void testPostConstructAdapterRead_thenNotJsonTreeReaderWithElementIsJsonNullHasNext()
      throws IOException {
    // Arrange
    ...
    // Act
    Object actualReadResult = postConstructAdapter.read(in);
  ...
  @ManagedByDiffblue
  @MethodsUnderTest({"Object PostConstructAdapter.read(JsonReader)"})
  public void testPostConstructAdapterRead_thenNotJsonTreeReaderWithElementIsJsonNullHasNext2()
      throws IOException {
    // Arrange
  ...
  @ManagedByDiffblue
  @MethodsUnderTest({"Object PostConstructAdapter.read(JsonReader)"})
  public void testPostConstructAdapterRead_whenStringReaderWithEmptyString_thenReturnNull()
      throws IOException {
    // Arrange
    JsonSerializer<Object> serializer = mock(JsonSerializer.class);
    JsonDeserializer<Object> deserializer = mock(JsonDeserializer.class);
    ...
    // Act
    Object actualReadResult = postConstructAdapter.read(new JsonReader(new StringReader("")));
  ...
  @ManagedByDiffblue
  @MethodsUnderTest({"void PostConstructAdapter.write(JsonWriter, Object)"})
  public void testPostConstructAdapterWrite_givenJsonArrayWithCapacityIsThreeAddJsonNull()
      throws IOException {
    // Arrange
    JsonArray jsonArray = new JsonArray(3);
  ...
  @ManagedByDiffblue
  @MethodsUnderTest({"void PostConstructAdapter.write(JsonWriter, Object)"})
  public void testPostConstructAdapterWrite_givenJsonArrayWithCapacityIsThreeAddJsonObject()
      throws IOException {
    // Arrange
    JsonArray jsonArray = new JsonArray(3);
   ...
   *
   * <ul>
   *   <li>Given {@link JsonObject} (default constructor) add {@code Property} and {@link JsonNull}
   *       (default constructor).
   * </ul>
   *
   * <p>Method under test: {@link PostConstructAdapter#write(JsonWriter, Object)}
  ...
  @ManagedByDiffblue
  @MethodsUnderTest({"void PostConstructAdapter.write(JsonWriter, Object)"})
  public void testPostConstructAdapterWrite_givenJsonObjectAddPropertyAndJsonNull()
      throws IOException {
    // Arrange
    JsonObject jsonObject = new JsonObject();
  ...
  @ManagedByDiffblue
  @MethodsUnderTest({"void PostConstructAdapter.write(JsonWriter, Object)"})
  public void testPostConstructAdapterWrite_givenTrue() throws IOException {
    // Arrange
    JsonSerializer<Object> serializer = mock(JsonSerializer.class);
    when(serializer.serialize(
            Mockito.<Object>any(), Mockito.<Type>any(), Mockito.<JsonSerializationContext>any()))
