...
public class JsonObjectDiffblueTest {
  ...
  @Category(MaintainedByDiffblue.class)
  @MethodsUnderTest({"boolean JsonObject.has(String)"})
  public void testHas_givenJsonObjectAddComGoogleGsonJsonObjectAndInstance_thenReturnFalse() {
    // Arrange
    JsonObject jsonObject = new JsonObject();
    jsonObject.add("com.google.gson.JsonObject", JsonNull.INSTANCE);
    jsonObject.add("Property", JsonNull.INSTANCE);
  ...
  @Category(MaintainedByDiffblue.class)
  @MethodsUnderTest({"JsonElement JsonObject.get(String)"})
  public void testGet_givenJsonObjectAddComGoogleGsonJsonObjectAndInstance_thenReturnNull() {
    // Arrange
    JsonObject jsonObject = new JsonObject();
    jsonObject.add("com.google.gson.JsonObject", JsonNull.INSTANCE);
    jsonObject.add("Property", JsonNull.INSTANCE);
  ...
  @Category(MaintainedByDiffblue.class)
  @MethodsUnderTest({"com.google.gson.JsonPrimitive JsonObject.getAsJsonPrimitive(String)"})
  public void testGetAsJsonPrimitiveWithString_givenJsonObject() {
    // Arrange, Act and Assert
  ...
  @Category(MaintainedByDiffblue.class)
  @MethodsUnderTest({"com.google.gson.JsonPrimitive JsonObject.getAsJsonPrimitive(String)"})
  public void testGetAsJsonPrimitiveWithString_givenJsonObjectAdd42AndInstance() {
    // Arrange
    JsonObject jsonObject = new JsonObject();
    jsonObject.add("42", JsonNull.INSTANCE);
  ...
  @Category(MaintainedByDiffblue.class)
  @MethodsUnderTest({"JsonArray JsonObject.getAsJsonArray(String)"})
  public void testGetAsJsonArrayWithString_givenJsonObject() {
    // Arrange, Act and Assert
  ...
  @Category(MaintainedByDiffblue.class)
  @MethodsUnderTest({"JsonArray JsonObject.getAsJsonArray(String)"})
  public void testGetAsJsonArrayWithString_givenJsonObjectAdd42AndInstance() {
    // Arrange
    JsonObject jsonObject = new JsonObject();
    jsonObject.add("42", JsonNull.INSTANCE);
  ...
  @Category(MaintainedByDiffblue.class)
  @MethodsUnderTest({"JsonObject JsonObject.getAsJsonObject(String)"})
  public void testGetAsJsonObjectWithString_givenJsonObject() {
    // Arrange, Act and Assert
  ...
  @Category(MaintainedByDiffblue.class)
  @MethodsUnderTest({"JsonObject JsonObject.getAsJsonObject(String)"})
  public void testGetAsJsonObjectWithString_givenJsonObjectAdd42AndInstance() {
    // Arrange
    JsonObject jsonObject = new JsonObject();
    jsonObject.add("42", JsonNull.INSTANCE);
