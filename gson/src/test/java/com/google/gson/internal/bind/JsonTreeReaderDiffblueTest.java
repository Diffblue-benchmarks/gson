...
public class JsonTreeReaderDiffblueTest {
  ...
  @InjectMocks private JsonTreeReader jsonTreeReader;
  ...
  @ManagedByDiffblue
  @MethodsUnderTest({"void JsonTreeReader.beginArray()"})
  public void testBeginArray_givenJsonElement_thenThrowMalformedJsonException() throws IOException {
    // Arrange, Act and Assert
    assertThrows(MalformedJsonException.class, () -> jsonTreeReader.beginArray());
  }
  ...
  public void testEndArray_givenJsonElement_thenThrowMalformedJsonException() throws IOException {
    // Arrange, Act and Assert
    assertThrows(MalformedJsonException.class, () -> jsonTreeReader.endArray());
  }
  ...
  public void testBeginObject_givenJsonElement_thenThrowMalformedJsonException()
      throws IOException {
    // Arrange, Act and Assert
    assertThrows(MalformedJsonException.class, () -> jsonTreeReader.beginObject());
  }
  ...
  public void testEndObject_givenJsonElement_thenThrowMalformedJsonException() throws IOException {
    // Arrange, Act and Assert
    assertThrows(MalformedJsonException.class, () -> jsonTreeReader.endObject());
  }
  ...
  public void testHasNext_givenJsonElement_thenThrowMalformedJsonException() throws IOException {
    // Arrange, Act and Assert
    assertThrows(MalformedJsonException.class, () -> jsonTreeReader.hasNext());
  }
  ...
  public void testPeek_givenJsonElement_thenThrowMalformedJsonException() throws IOException {
    // Arrange, Act and Assert
    assertThrows(MalformedJsonException.class, () -> jsonTreeReader.peek());
  }
  ...
  public void testNextName_givenJsonElement_thenThrowMalformedJsonException() throws IOException {
    // Arrange, Act and Assert
    assertThrows(MalformedJsonException.class, () -> jsonTreeReader.nextName());
  }
  ...
  public void testNextString_givenJsonElement_thenThrowMalformedJsonException() throws IOException {
    // Arrange, Act and Assert
    assertThrows(MalformedJsonException.class, () -> jsonTreeReader.nextString());
  }
  ...
  public void testNextBoolean_givenJsonElement_thenThrowMalformedJsonException()
      throws IOException {
    // Arrange, Act and Assert
    assertThrows(MalformedJsonException.class, () -> jsonTreeReader.nextBoolean());
  }
  ...
  public void testNextNull_givenJsonElement_thenThrowMalformedJsonException() throws IOException {
    // Arrange, Act and Assert
    assertThrows(MalformedJsonException.class, () -> jsonTreeReader.nextNull());
  }
  ...
  public void testNextDouble_givenJsonElement_thenThrowMalformedJsonException() throws IOException {
    // Arrange, Act and Assert
    assertThrows(MalformedJsonException.class, () -> jsonTreeReader.nextDouble());
  }
   ...
   * <ul>
   *   <li>Given {@link JsonTreeReader#JsonTreeReader(JsonElement)} with element is {@link
   *       JsonPrimitive#JsonPrimitive(String)}.
  ...
  @ManagedByDiffblue
  @MethodsUnderTest({"double JsonTreeReader.nextDouble()"})
  public void testNextDouble_givenJsonTreeReaderWithElementIsJsonPrimitive_thenReturnFortyTwo()
      throws IOException {
    // Arrange
    JsonTreeReader jsonTreeReader = new JsonTreeReader(new JsonPrimitive("42"));
  ...
  public void testNextLong_givenJsonElement_thenThrowMalformedJsonException() throws IOException {
    // Arrange, Act and Assert
    assertThrows(MalformedJsonException.class, () -> jsonTreeReader.nextLong());
  }
  ...
  public void testNextInt_givenJsonElement_thenThrowMalformedJsonException() throws IOException {
    // Arrange, Act and Assert
    assertThrows(MalformedJsonException.class, () -> jsonTreeReader.nextInt());
  }
  ...
  public void testNextJsonElement_givenJsonElement_thenThrowMalformedJsonException()
      throws IOException {
    // Arrange, Act and Assert
    assertThrows(MalformedJsonException.class, () -> jsonTreeReader.nextJsonElement());
  }
  ...
  @ManagedByDiffblue
  @MethodsUnderTest({"void JsonTreeReader.skipValue()"})
  public void testSkipValue_givenJsonElement_thenThrowMalformedJsonException() throws IOException {
    // Arrange, Act and Assert
    assertThrows(MalformedJsonException.class, () -> jsonTreeReader.skipValue());
  }
  ...
  @ManagedByDiffblue
  @MethodsUnderTest({"void JsonTreeReader.promoteNameToValue()"})
  public void testPromoteNameToValue_givenJsonElement_thenThrowMalformedJsonException()
      throws IOException {
    // Arrange, Act and Assert
    assertThrows(MalformedJsonException.class, () -> jsonTreeReader.promoteNameToValue());
  }
