...
public class NumberTypeAdapterDiffblueTest {
  ...
  public void testGetFactory_whenBig_decimal_thenReturnCreateGsonAndObjectIsNull() {
    // Arrange and Act
    TypeAdapterFactory actualFactory = NumberTypeAdapter.getFactory(ToNumberPolicy.BIG_DECIMAL);
    Gson gson = new Gson();
