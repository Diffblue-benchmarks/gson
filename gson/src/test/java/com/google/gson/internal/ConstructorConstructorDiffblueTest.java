...
public class ConstructorConstructorDiffblueTest {
  ...
  public void testCheckInstantiable_whenCreateRecordClass_thenReturnNull() {
    // Arrange
  ...
  @Category(ContributionFromDiffblue.class)
  @ManagedByDiffblue
  @MethodsUnderTest({"ObjectConstructor ConstructorConstructor.get(TypeToken, boolean)"})
  ...
  @Category(ContributionFromDiffblue.class)
  @ManagedByDiffblue
  @MethodsUnderTest({"ObjectConstructor ConstructorConstructor.get(TypeToken)"})
  public void testGetWithTypeToken_givenReflectionAccessFilterCheckReturnAllow_thenCallsCheck() {
    ...
    // Act
    ObjectConstructor<Object> actualGetResult = constructorConstructor.get(typeToken);
    actualGetResult.construct();
