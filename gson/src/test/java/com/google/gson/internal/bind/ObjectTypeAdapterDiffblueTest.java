...
public class ObjectTypeAdapterDiffblueTest {
   ...
   *
   * <ul>
   *   <li>When {@link ToNumberPolicy#BIG_DECIMAL}.
  ...
  public void testGetFactory_whenBig_decimal_thenCreateGsonAndObjectReturnObjectTypeAdapter() {
    // Arrange and Act
    TypeAdapterFactory actualFactory = ObjectTypeAdapter.getFactory(ToNumberPolicy.BIG_DECIMAL);
    Gson gson = new Gson();
