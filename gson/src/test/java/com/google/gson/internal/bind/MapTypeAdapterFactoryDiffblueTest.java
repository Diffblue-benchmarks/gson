...
public class MapTypeAdapterFactoryDiffblueTest {
  /** Method under test: {@link MapTypeAdapterFactory#create(Gson, TypeToken)} */
  @Test
  ...
  /**
   * Method under test: {@link MapTypeAdapterFactory#MapTypeAdapterFactory(ConstructorConstructor,
   * boolean)}
   */
  @Test
