...
public class ISO8601UtilsDiffblueTest {
   ...
   *
   * <ul>
   *   <li>Then return {@code 1970-01-01T00:00:00.001+00:00}.
   * </ul>
   *
   * <p>Method under test: {@link ISO8601Utils#format(Date, boolean, TimeZone)}
   */
  ...
  @ManagedByDiffblue
  @MethodsUnderTest({"String ISO8601Utils.format(Date, boolean, TimeZone)"})
  public void testFormatWithDateMillisTz_thenReturn19700101t0000000010000() {
    // Arrange
    Date date =
        Date.from(LocalDate.of(1970, 1, 1).atStartOfDay().atZone(ZoneOffset.UTC).toInstant());
   ...
   *
   * <ul>
   *   <li>When {@link ParsePosition#ParsePosition(int)} with three.
   *   <li>Then throw {@link ParseException}.
   * </ul>
   *
   * <p>Method under test: {@link ISO8601Utils#parse(String, ParsePosition)}
  ...
  @ManagedByDiffblue
  @MethodsUnderTest({"Date ISO8601Utils.parse(String, ParsePosition)"})
  public void testParse_whenParsePositionWithThree_thenThrowParseException() throws ParseException {
    // Arrange, Act and Assert
    assertThrows(ParseException.class, () -> ISO8601Utils.parse("20200301", new ParsePosition(3)));
  }
}
