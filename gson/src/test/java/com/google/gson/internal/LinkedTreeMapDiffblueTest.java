...
public class LinkedTreeMapDiffblueTest {
  ...
  @ManagedByDiffblue
  @MethodsUnderTest({"boolean KeySet.contains(Object)"})
  public void testKeySetContains_givenLinkedTreeMapIfAbsent42Is42_when42_thenReturnTrue2() {
    // Arrange
    LinkedTreeMap linkedTreeMap = new LinkedTreeMap();
    linkedTreeMap.put("Key", "Value");
    linkedTreeMap.putIfAbsent("42", "42");
  ...
  public void testNodeEquals_whenOtherIsDifferent_thenReturnNotEqual8() {
    ...
    Node<Object, Object> node = new Node<>(true, parent, "42", next, new Node<>(true));
  ...
  @ManagedByDiffblue
  @MethodsUnderTest({"Object LinkedTreeMap.remove(Object)"})
  public void testRemoveWithObject_givenLinkedTreeMapIfAbsent42Is42_thenLinkedTreeMapSizeIsTwo() {
    // Arrange
    LinkedTreeMap<Object, Object> objectObjectMap = new LinkedTreeMap<>();
    objectObjectMap.put("com.google.gson.internal.LinkedTreeMap", "Value");
    objectObjectMap.putIfAbsent("42", "42");
  ...
  @ManagedByDiffblue
  @MethodsUnderTest({"Object LinkedTreeMap.remove(Object)"})
  public void testRemoveWithObject_givenLinkedTreeMapIfAbsent42Is42_whenKey_thenReturnNull() {
    // Arrange
    LinkedTreeMap<Object, Object> objectObjectMap = new LinkedTreeMap<>();
    objectObjectMap.putIfAbsent("42", "42");
  ...
  public void testFindByEntry_givenLinkedTreeMap42IsValue_thenReturnNull() {
    ...
    Node<Object, Object> actualFindByEntryResult =
        objectObjectMap.findByEntry(new SimpleEntry<>("42", "42"));
  ...
  @ManagedByDiffblue
  @MethodsUnderTest({"Node LinkedTreeMap.findByEntry(Entry)"})
  public void testFindByEntry_givenLinkedTreeMapEmptyStringIsValue_thenReturnNull() {
    // Arrange
    LinkedTreeMap<Object, Object> objectObjectMap = new LinkedTreeMap<>();
  ...
  @ManagedByDiffblue
  @MethodsUnderTest({"Node LinkedTreeMap.findByEntry(Entry)"})
  public void testFindByEntry_givenLinkedTreeMapKeyIsValue_thenReturnNull() {
    // Arrange
    LinkedTreeMap<Object, Object> objectObjectMap = new LinkedTreeMap<>();
    objectObjectMap.put("Key", "Value");
  ...
  public void testFindByEntry_givenLinkedTreeMap_whenSimpleEntryWithNullAnd42_thenReturnNull() {
    ...
    // Act
    Node<Object, Object> actualFindByEntryResult =
        objectObjectMap.findByEntry(new SimpleEntry<>(null, "42"));
   ...
   *
   * <ul>
   *   <li>Then return {@link SimpleEntry#SimpleEntry(Object, Object)} with {@code 42} and {@code
   *       42}.
   * </ul>
   *
   * <p>Method under test: {@link LinkedTreeMap#findByEntry(Entry)}
  ...
  @ManagedByDiffblue
  @MethodsUnderTest({"Node LinkedTreeMap.findByEntry(Entry)"})
  public void testFindByEntry_thenReturnSimpleEntryWith42And42() {
    // Arrange
    LinkedTreeMap<Object, Object> objectObjectMap = new LinkedTreeMap<>();
    objectObjectMap.put("Key", "Value");
    objectObjectMap.putIfAbsent("42", "42");
  ...
  public void testRemoveInternalByKey_thenLinkedTreeMapSizeIsThree() {
    ...
    assertEquals(3, objectObjectMap.size());
    Node<Object, Object> node = actualRemoveInternalByKeyResult.next;
    Node<Object, Object> firstResult = node.first();
    assertEquals("42", firstResult.getKey());
    assertEquals("42", firstResult.getValue());
    assertNull(firstResult.left);
    assertNull(firstResult.right);
    assertEquals(1, firstResult.height);
    assertTrue(objectObjectMap.containsKey("42"));
    assertTrue(objectObjectMap.containsKey("com.google.gson.internal.LinkedTreeMap"));
    assertTrue(objectObjectMap.containsKey("foo"));
    assertTrue(firstResult.allowNullValue);
    Node<Object, Object> firstResult2 = firstResult.first();
    assertSame(firstResult2, firstResult2);
    assertSame(firstResult2, node.left);
    assertSame(firstResult2, node.next.next);
    assertSame(firstResult2, actualRemoveInternalByKeyResult.prev.prev);
    assertSame(objectObjectMap.header, firstResult.prev);
    assertSame(actualRemoveInternalByKeyResult.next, firstResult.parent);
    assertSame(actualRemoveInternalByKeyResult.prev, firstResult.next);
  }
  ...
  @ManagedByDiffblue
  @MethodsUnderTest({"Node LinkedTreeMap.removeInternalByKey(Object)"})
  public void testRemoveInternalByKey_thenLinkedTreeMapSizeIsTwo() {
    // Arrange
    LinkedTreeMap<Object, Object> objectObjectMap = new LinkedTreeMap<>();
    objectObjectMap.putIfAbsent("foo", "42");
    objectObjectMap.put("Key", "Value");
    ...
    Node<Object, Object> node3 = node2.next;
    ...
    assertTrue(objectObjectMap.containsKey("com.google.gson.internal.LinkedTreeMap"));
    assertTrue(objectObjectMap.containsKey("foo"));
    Node<Object, Object> expectedFirstResult = objectObjectMap.header;
    assertSame(expectedFirstResult, node3.first());
    assertSame(objectObjectMap.root, node3.prev);
    assertSame(actualRemoveInternalByKeyResult.next, node.parent);
    Node<Object, Object> node4 = actualRemoveInternalByKeyResult.prev;
    assertSame(node4, node3.next);
    assertSame(node4, node2.right);
  }
   ...
   *
   * <ul>
   *   <li>Then return {@link Node#next} Value is {@code Value}.
   * </ul>
   *
   * <p>Method under test: {@link LinkedTreeMap#removeInternalByKey(Object)}
   */
  ...
  @ManagedByDiffblue
  @MethodsUnderTest({"Node LinkedTreeMap.removeInternalByKey(Object)"})
  public void testRemoveInternalByKey_thenReturnNextValueIsValue() {
    // Arrange
    LinkedTreeMap<Object, Object> objectObjectMap = new LinkedTreeMap<>();
    objectObjectMap.put("Key", "Value");
    objectObjectMap.put("com.google.gson.internal.LinkedTreeMap", "Value");
  ...
  public void testRemoveInternalByKey_thenReturnPrevValueIsValue() {
    ...
    Node<Object, Object> node2 = objectObjectMap.root;
    assertSame(node2, node.first());
    assertSame(node2, actualRemoveInternalByKeyResult.next.prev);
  }
