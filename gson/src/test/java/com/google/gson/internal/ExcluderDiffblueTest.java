...
public class ExcluderDiffblueTest {
   ...
   * <ul>
   *   <li>When {@code false}.
   *   <li>Then return not excludeClass {@code null} and {@code true}.
   * </ul>
   *
  ...
  public void testWithExclusionStrategy_whenFalse_thenReturnNotExcludeClassNullAndTrue() {
    // Arrange, Act and Assert
    assertFalse(
        Excluder.DEFAULT.withExclusionStrategy(null, false, false).excludeClass(null, true));
  }
