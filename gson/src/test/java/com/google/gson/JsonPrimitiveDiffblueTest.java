...
public class JsonPrimitiveDiffblueTest {
  ...
  public void testNewJsonPrimitive() {
    ...
    assertEquals(Boolean.TRUE.toString(), actualJsonPrimitive.getAsString());
    JsonPrimitive actualAsJsonPrimitive = actualJsonPrimitive.getAsJsonPrimitive();
    assertSame(actualJsonPrimitive, actualAsJsonPrimitive);
  }
  ...
  public void testNewJsonPrimitive_whenValueOfOne_thenReturnAsStringIs1() {
    ...
    assertEquals(new BigDecimal("1"), actualJsonPrimitive.getAsBigDecimal());
    JsonPrimitive actualAsJsonPrimitive = actualJsonPrimitive.getAsJsonPrimitive();
    assertSame(actualJsonPrimitive, actualAsJsonPrimitive);
  ...
  public void testDeepCopy() {
    ...
    // Act
    JsonPrimitive actualDeepCopyResult = jsonPrimitive.deepCopy();

    // Assert
    assertSame(jsonPrimitive, actualDeepCopyResult);
  }
  ...
  /**
   * Test {@link JsonPrimitive#getAsBoolean()}.
   *
   * <ul>
   *   <li>Given {@link JsonPrimitive#JsonPrimitive(Boolean)} with bool is {@code true}.
   *   <li>Then return {@code true}.
   * </ul>
   *
   * <p>Method under test: {@link JsonPrimitive#getAsBoolean()}
   */
  @Test
  @Category(ContributionFromDiffblue.class)
  @ManagedByDiffblue
  @MethodsUnderTest({"boolean JsonPrimitive.getAsBoolean()"})
  public void testGetAsBoolean_givenJsonPrimitiveWithBoolIsTrue_thenReturnTrue() {
    // Arrange, Act and Assert
   ...
   *
   * <ul>
   *   <li>Given {@link JsonPrimitive#JsonPrimitive(String)} with string is {@link Boolean#TRUE}
   *       toString.
   *   <li>Then return {@code true}.
   * </ul>
   *
  ...
  @ManagedByDiffblue
  @MethodsUnderTest({"boolean JsonPrimitive.getAsBoolean()"})
  public void testGetAsBoolean_givenJsonPrimitiveWithStringIsTrueToString_thenReturnTrue() {
    // Arrange, Act and Assert
    assertTrue(new JsonPrimitive(Boolean.TRUE.toString()).getAsBoolean());
  }
  ...
  @ManagedByDiffblue
  @MethodsUnderTest({"boolean JsonPrimitive.getAsBoolean()"})
  public void testGetAsBoolean_givenJsonPrimitiveWithString_thenReturnFalse() {
    // Arrange, Act and Assert
  ...
  public void testGetAsString_givenJsonPrimitiveWithBoolIsTrue_thenReturnTrueToString() {
    // Arrange, Act and Assert
    assertEquals(Boolean.TRUE.toString(), new JsonPrimitive(true).getAsString());
  }
  ...
  public void testGetAsBigInteger_givenJsonPrimitiveWithStringIs42_thenReturnToStringIs42() {
    ...
    assertEquals(BigInteger.TWO, sqrtResult.sqrt());
  }
  ...
  /**
   * Test {@link JsonPrimitive#getAsInt()}.
   *
   * <ul>
   *   <li>Given {@link JsonPrimitive#JsonPrimitive(String)} with string is {@code 1}.
   *   <li>Then return one.
   * </ul>
   *
   * <p>Method under test: {@link JsonPrimitive#getAsInt()}
   */
  @Test
  @Category(ContributionFromDiffblue.class)
  @ManagedByDiffblue
  @MethodsUnderTest({"int JsonPrimitive.getAsInt()"})
  public void testGetAsInt_givenJsonPrimitiveWithStringIs1_thenReturnOne() {
    // Arrange, Act and Assert
    assertEquals(1, new JsonPrimitive("1").getAsInt());
  }
  ...
  /**
   * Test {@link JsonPrimitive#getAsCharacter()}.
   *
   * <ul>
   *   <li>Given {@link JsonPrimitive#JsonPrimitive(Boolean)} with bool is {@code true}.
   ...
   * </ul>
   *
   * <p>Method under test: {@link JsonPrimitive#getAsCharacter()}
   */
  @Test
  @Category(ContributionFromDiffblue.class)
  @ManagedByDiffblue
  @MethodsUnderTest({"char JsonPrimitive.getAsCharacter()"})
  public void testGetAsCharacter_givenJsonPrimitiveWithBoolIsTrue_thenReturnT() {
    // Arrange, Act and Assert
  ...
  @ManagedByDiffblue
  @MethodsUnderTest({"char JsonPrimitive.getAsCharacter()"})
  public void testGetAsCharacter_givenJsonPrimitiveWithString_thenReturnS() {
    // Arrange, Act and Assert
  ...
  public void testGetAsCharacter_thenThrowUnsupportedOperationException() {
    // Arrange, Act and Assert
    assertThrows(UnsupportedOperationException.class, () -> new JsonPrimitive("").getAsCharacter());
  }
