...
public class TypeAdapterDiffblueTest {
  ...
  public void testToJsonWithOutValue() throws IOException {
    // Arrange
    ...
    // Act
    futureTypeAdapter.toJson(out, "Value");
  ...
  @ManagedByDiffblue
  @MethodsUnderTest({"void TypeAdapter.toJson(Writer, Object)"})
  public void testToJsonWithOutValue2() throws IOException {
    // Arrange
    JsonSerializer<Object> serializer = mock(JsonSerializer.class);
    when(serializer.serialize(
            Mockito.<Object>any(), Mockito.<Type>any(), Mockito.<JsonSerializationContext>any()))
   ...
   *
   * <ul>
   *   <li>Then {@link StringWriter#StringWriter()} toString is {@code [32]}.
   * </ul>
   *
   * <p>Method under test: {@link TypeAdapter#toJson(Writer, Object)}
   */
  ...
  @ManagedByDiffblue
  @MethodsUnderTest({"void TypeAdapter.toJson(Writer, Object)"})
  public void testToJsonWithOutValue_thenStringWriterToStringIs32() throws IOException {
    // Arrange
  ...
  @ManagedByDiffblue
  @MethodsUnderTest({"void TypeAdapter.toJson(Writer, Object)"})
  public void testToJsonWithOutValue_thenStringWriterToStringIsFalseTrue() throws IOException {
    // Arrange
    JsonArray jsonArray = new JsonArray(3);
    jsonArray.add(false);
    jsonArray.add(true);
    ...
    verify(serializer)
        .serialize(isA(Object.class), isA(Type.class), isA(JsonSerializationContext.class));
    assertEquals("[false,true]", out.toString());
  }
  ...
  @ManagedByDiffblue
  @MethodsUnderTest({"void TypeAdapter.toJson(Writer, Object)"})
  public void testToJsonWithOutValue_thenStringWriterToStringIsNull() throws IOException {
    // Arrange
    JsonSerializer<Object> serializer = mock(JsonSerializer.class);
    when(serializer.serialize(
            Mockito.<Object>any(), Mockito.<Type>any(), Mockito.<JsonSerializationContext>any()))
  ...
  @ManagedByDiffblue
  @MethodsUnderTest({"void TypeAdapter.toJson(Writer, Object)"})
  public void testToJsonWithOutValue_thenStringWriterToStringIsNull2() throws IOException {
    // Arrange
    JsonArray jsonArray = new JsonArray(3);
   ...
   *
   * <ul>
   *   <li>Then {@link StringWriter#StringWriter()} toString is {@code {",":null,"out ==
   *       null":null}}.
   * </ul>
   *
   * <p>Method under test: {@link TypeAdapter#toJson(Writer, Object)}
  ...
  @ManagedByDiffblue
  @MethodsUnderTest({"void TypeAdapter.toJson(Writer, Object)"})
  public void testToJsonWithOutValue_thenStringWriterToStringIsNullOutNullNull()
      throws IOException {
    // Arrange
    ...
    verify(serializer)
        .serialize(isA(Object.class), isA(Type.class), isA(JsonSerializationContext.class));
    assertEquals("{\",\":null,\"out == null\":null}", out.toString());
  }
   ...
   *
   * <ul>
   *   <li>Then {@link StringWriter#StringWriter()} toString is {@code "out == null"}.
   * </ul>
   *
   * <p>Method under test: {@link TypeAdapter#toJson(Writer, Object)}
   */
  ...
  @ManagedByDiffblue
  @MethodsUnderTest({"void TypeAdapter.toJson(Writer, Object)"})
  public void testToJsonWithOutValue_thenStringWriterToStringIsOutNull() throws IOException {
    // Arrange
    JsonSerializer<Object> serializer = mock(JsonSerializer.class);
    when(serializer.serialize(
            Mockito.<Object>any(), Mockito.<Type>any(), Mockito.<JsonSerializationContext>any()))
    ...
    verify(serializer)
        .serialize(isA(Object.class), isA(Type.class), isA(JsonSerializationContext.class));
    assertEquals("\"out == null\"", out.toString());
  }
   ...
   *
   * <ul>
   *   <li>Then {@link StringWriter#StringWriter()} toString is {@code {"out == null":null}}.
   * </ul>
   *
   * <p>Method under test: {@link TypeAdapter#toJson(Writer, Object)}
   */
  ...
  @ManagedByDiffblue
  @MethodsUnderTest({"void TypeAdapter.toJson(Writer, Object)"})
  public void testToJsonWithOutValue_thenStringWriterToStringIsOutNullNull() throws IOException {
    // Arrange
    JsonObject jsonObject = new JsonObject();
    jsonObject.add("out == null", JsonNull.INSTANCE);
    ...
    verify(serializer)
        .serialize(isA(Object.class), isA(Type.class), isA(JsonSerializationContext.class));
    assertEquals("{\"out == null\":null}", out.toString());
  }
  ...
  @ManagedByDiffblue
  @MethodsUnderTest({"void TypeAdapter.toJson(Writer, Object)"})
  public void testToJsonWithOutValue_thenStringWriterToStringIsTrue() throws IOException {
    // Arrange
    JsonArray jsonArray = new JsonArray(3);
    jsonArray.add(true);
   ...
   *
   * <ul>
   *   <li>Then {@link StringWriter#StringWriter()} toString is {@link Boolean#TRUE} toString.
   * </ul>
   *
   * <p>Method under test: {@link TypeAdapter#toJson(Writer, Object)}
   */
  ...
  @ManagedByDiffblue
  @MethodsUnderTest({"void TypeAdapter.toJson(Writer, Object)"})
  public void testToJsonWithOutValue_thenStringWriterToStringIsTrueToString() throws IOException {
    // Arrange
    JsonSerializer<Object> serializer = mock(JsonSerializer.class);
    when(serializer.serialize(
            Mockito.<Object>any(), Mockito.<Type>any(), Mockito.<JsonSerializationContext>any()))
    ...
    verify(serializer)
        .serialize(isA(Object.class), isA(Type.class), isA(JsonSerializationContext.class));
    assertEquals(Boolean.TRUE.toString(), out.toString());
  }
  ...
  @ManagedByDiffblue
  @MethodsUnderTest({"void TypeAdapter.toJson(Writer, Object)"})
  public void testToJsonWithOutValue_thenStringWriterToStringIsU0006() throws IOException {
    // Arrange
    JsonArray jsonArray = new JsonArray(3);
    jsonArray.add('\u0006');
  ...
  @ManagedByDiffblue
  @MethodsUnderTest({"void TypeAdapter.toJson(Writer, Object)"})
  public void testToJsonWithOutValue_whenNull_thenStringWriterToStringIsNull() throws IOException {
    // Arrange
    FutureTypeAdapter<Object> futureTypeAdapter = new FutureTypeAdapter<>();
    JsonSerializer<Object> serializer = mock(JsonSerializer.class);
    JsonDeserializer<Object> deserializer = mock(JsonDeserializer.class);
    ...
    // Act
    futureTypeAdapter.toJson(out, null);
  ...
  public void testToJsonTree_givenJsonArrayWithCapacityIsThreeAddTrue_thenReturnAsCharacterIsT() {
    ...
    assertEquals(Boolean.TRUE.toString(), actualToJsonTreeResult.getAsString());
  ...
  public void testFromJsonWithIn_whenStringReaderWith42_thenReturnDeserialize()
  ...
  @ManagedByDiffblue
  @MethodsUnderTest({"Object TypeAdapter.fromJson(Reader)"})
  public void testFromJsonWithIn_whenStringReaderWithEmptyString_thenReturnNull()
      throws IOException {
    // Arrange
    FutureTypeAdapter<Object> futureTypeAdapter = new FutureTypeAdapter<>();
    JsonSerializer<Object> serializer = mock(JsonSerializer.class);
    ...
    // Act
    Object actualFromJsonResult = futureTypeAdapter.fromJson(new StringReader(""));
  ...
  @ManagedByDiffblue
  @MethodsUnderTest({"Object TypeAdapter.fromJson(Reader)"})
  public void testFromJsonWithIn_whenStringReaderWithFalseToString_thenReturnDeserialize()
      throws JsonParseException, IOException {
    // Arrange
    JsonDeserializer<Object> deserializer = mock(JsonDeserializer.class);
    when(deserializer.deserialize(
  ...
  @ManagedByDiffblue
  @MethodsUnderTest({"Object TypeAdapter.fromJson(Reader)"})
  public void testFromJsonWithIn_whenStringReaderWithFalse_thenReturnDeserialize()
      throws JsonParseException, IOException {
    // Arrange
    JsonDeserializer<Object> deserializer = mock(JsonDeserializer.class);
    when(deserializer.deserialize(
    ...
    // Act
    Object actualFromJsonResult = futureTypeAdapter.fromJson(new StringReader("FALSE"));
